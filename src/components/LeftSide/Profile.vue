<template>
     <div class="w-14 xl:w-full mx-auto mt-auto flex flex-row justify-between mb-5 rounded-full hover:bg-blue-50 dark:hover:bg-dim-800 p-2 cursor-pointer transition duration-350 ease-in-out mb-2">
                <div class="flex flex-row">
                    ...
                    <div class="hidden xl:block flex flex-col ml-2">
                        <h1 class="text-gray-800 dark:text-black font-bold text-sm">
                            Joe Biden
                        </h1>
                ...
                <div class="hidden xl:block">
                    <div class="flex items-center h-full text-gray-800 dark:text-black">
