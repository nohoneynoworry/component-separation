        ...
        <div class="flex flex-col h-screen xl:pr-3 fixed overflow-y-auto w-68 xs:w-88 xl:w-275">
           <Logo/>
            <nav class="mt-5">
                ...
                <a href="#"
                    class="flex items-center justify-center xl:justify-start text-gray-800 dark:text-black hover:text-blue-400 dark:hover:text-blue-400 mb-8 transition duration-350 ease-in-out">
                    <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<script>
import Logo from './LeftSide/Logo.vue';
import Profile from './LeftSide/Profile.vue';
export default {
    components:{
        Logo,
        Profile
